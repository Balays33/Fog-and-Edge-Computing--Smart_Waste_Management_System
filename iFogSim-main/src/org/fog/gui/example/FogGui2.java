...
public class FogGui2 extends JFrame {
            ...
            public void actionPerformed(ActionEvent event) {
            	if("i"==mode){
            		...
            		SDNRun run = new SDNRun(physicalTopologyFile, deploymentFile, 
            								workloads_background, workloads, FogGui2.this);
	...
	protected void openAddActuatorDialog() {
		AddActuator actuator = new AddActuator(physicalGraph, FogGui2.this);
		physicalCanvas.repaint();
	}
	
	protected void openAddLinkDialog() {
		AddLink phyEdge = new AddLink(physicalGraph, FogGui2.this);
    	physicalCanvas.repaint();
		
	}

	protected void openAddFogDeviceDialog() {
		AddFogDevice fogDevice = new AddFogDevice(physicalGraph, FogGui2.this);
    	physicalCanvas.repaint();
    ...
    private void openAddPhysicalNodeDialog(){
    	AddPhysicalNode phyNode = new AddPhysicalNode(physicalGraph, FogGui2.this);
    	physicalCanvas.repaint();
    }
    private void openAddPhysicalEdgeDialog(){
    	AddPhysicalEdge phyEdge = new AddPhysicalEdge(physicalGraph, FogGui2.this);
    	physicalCanvas.repaint();
    }

    protected void openAddSensorDialog() {
		AddSensor sensor = new AddSensor(physicalGraph, FogGui2.this);
		physicalCanvas.repaint();
	}
